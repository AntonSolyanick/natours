    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          throw new Error("".concat(res.message));
        case 10:
          _context.next = 15;
          break;
        case 12:
...
},{"./alerts":"alerts.js"}],"../../utils/catchAsync.js":[function(require,module,exports) {
...
},{"../../utils/catchAsync":"../../utils/catchAsync.js","./alerts":"alerts.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var email, name, passwordCurrent, password, confirmPassword, photo, url, res, _data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          email = data.email, name = data.name, passwordCurrent = data.passwordCurrent, password = data.password, confirmPassword = data.confirmPassword, photo = data.photo;
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('success', 'Data was successfully updated');
          _context.next = 14;
          break;
        case 13:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch('/api/v1/bookings/checkout-session/5c88fa8cf4afda39709c2955');
        case 3:
...
if (bookButton) {
  bookButton.addEventListener('click', _stripe.bookTour);
}
